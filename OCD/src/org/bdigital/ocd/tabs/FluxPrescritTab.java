...
public abstract class FluxPrescritTab {
	...
	public static void generateTab(HashMap<String, Question> questionsMap,
    	...
    	tab.setTitle("Flux prescrit");
    	UtilsTabs.addSmallField("46","47",questionsMap,rows);
    	UtilsTabs.addSmallField("48","",questionsMap,rows);
