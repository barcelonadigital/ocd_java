 ...
 * @author jroda
 */
public class CaseFormBoxesDetailsForm extends CaseBaseForm {
	...
	private HashMap<String,String> questionTextValueMap = new HashMap<String,String>();
	...
	public String getQuestionTextValue(String index) {
		return questionTextValueMap.get(index);
	}
	public void setQuestionTextValue(String index, String value) {
		this.questionTextValueMap.put(index,value);
	}
